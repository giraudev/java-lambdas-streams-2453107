...
public class EmployeeUtils {
  ...
  public String getManagersLastName(Employee employee) {
    Function<Employee, String> managersLastName = (e -> e.getLastName());
  ...
  public boolean hasMoreThanThreeYearsOfServiceAndLessThanTwoDirectReports(Employee employee) {
    Predicate<Employee> moreThanThreeYearsOfServiceAndLessThanTwoDirectReports = e1 ->
      e1.getYearsOfService() > 3 && e1.getNumberOfDirectReports() > 2;
